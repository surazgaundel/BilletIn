  ...
  return (
    <div className="h-[70vh] flex flex-row items-center justify-around">
        <article className="p-1 w-[80%] md:w-[60%]">
            ...
            <Link to='/products' className=' px-3 text-xl py-1 rounded-md text-white transition ease-in-out delay-150 bg-darkRed hover:-translate-y-1 hover:scale-110 hover:bg-green duration-300'>Shop Now</Link>
        </article>
