  ...
  return (
    <div className="h-[70vh] flex flex-row items-center justify-around">
        <article className="p-1 w-[80%] md:w-[60%]">
            <h1 className='text-2xl md:text-4xl lg:text-6xl font-bold tracking-wider'>Unwind your Mind,<br/> Embrace Serenity</h1>
            ...
            <Link to='/products' className='hover-btn'>Shop Now</Link>
        </article>
